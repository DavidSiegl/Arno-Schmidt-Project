...
ggplot(data = world) +
    geom_sf(fill="white", color="white") +
    geom_path(data = rivers_f, aes(x = long, y = lat, group = group), color = waterColor, size = 1) +
    geom_path(data = locations_lived_1stperiod, aes(x = long, y = lat), color = "red", size = 0.3) +
...
ggplot(data = world) +
    geom_sf(fill="white", color="white") +
    geom_path(data = rivers_f, aes(x = long, y = lat, group = group), color = waterColor, size = 1) +
    geom_path(data = locations_lived_2ndperiod, aes(x=long, y=lat), color = "red", size = 0.3) +
...
ggplot(data = world) +
    ...
    geom_path(data = locations_lived_3rdperiod, aes(x = long, y = lat), color = "red", size = 0.3) +
